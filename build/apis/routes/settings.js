...
exports.default = (function (app) {
    ...
    route.get('/', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
        var logger, settingsServiceInstance, settings, e_1;
    ...
    route.put('/', validators_1.default.addSettingsValidate, function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
        var logger, settingsServiceInstance, settings, e_2;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    logger = typedi_1.Container.get('logger');
                ...
                case 1:
                    _a.trys.push([1, 3, , 4]);
                    settingsServiceInstance = typedi_1.Container.get(settings_1.default);
                    return [4 /*yield*/, settingsServiceInstance.updateSettings(req.body)];
                case 2:
                    settings = (_a.sent()).settings;
                    return [2 /*return*/, res.status(200).json({
                            status: true,
