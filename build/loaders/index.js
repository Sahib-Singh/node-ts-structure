                ...
                case 1:
                    ...
                    return [4 /*yield*/, dependencyInjector_1.default({
                            ...
                            models: [
                                ...
                                {
                                    name: 'settingsModel',
                                    model: require('../models/settings').default,
                                },
                                {
                                    name: 'IndividualFormModel',
                                    model: require('../models/individualForm').default,
                                },
                                {
                                    name: 'SchoolFormModel',
                                    model: require('../models/schoolForm').default,
                                },
                                {
                                    name: 'CorporateFormModel',
                                    model: require('../models/corporateForm').default,
                                },
                                {
                                    name: 'eventModel',
                                    model: require('../models/events').default,
                                }
                            ]
                        })];
                case 2:
                    ...
                    agenda.start();
                    loggers_1.default.info('✌️ Dependency Injector loaded');
                    return [4 /*yield*/, express_1.default({ app: expressApp })];
                case 3:
                    _b.sent();
                    loggers_1.default.info('✌️ Express loaded');
                    return [2 /*return*/];
            }
        });
    });
